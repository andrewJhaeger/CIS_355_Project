...
-- 
-- Host: localhost
-- Generation Time: Apr 14, 2014 at 12:46 AM
-- Server version: 5.0.27
-- PHP Version: 5.2.1
-- 
-- Database: `airline`
-- 
CREATE DATABASE `airline` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `airline`;
...
CREATE TABLE `surveyinfo` (
  `surveyindex` mediumint(9) NOT NULL auto_increment,
  `FlightNum` mediumint(5) NOT NULL,
  `FlightDate` date NOT NULL,
  `Friendliness` char(4) NOT NULL,
  `Space` char(4) NOT NULL,
  `Comfort` char(4) NOT NULL,
  `Cleanliness` char(4) NOT NULL,
  `Noise` char(4) NOT NULL,
...
INSERT INTO `surveyinfo` (`surveyindex`, `FlightNum`, `FlightDate`, `Friendliness`, `Space`, `Comfort`, `Cleanliness`, `Noise`) VALUES 
(5, 12345, '2014-12-04', 'none', 'poor', 'fair', 'good', 'exce'),
(6, 12345, '2014-03-21', 'exce', 'exce', 'exce', 'exce', 'exce'),
(7, 12345, '2014-03-21', 'exce', 'exce', 'exce', 'exce', 'exce'),
(8, 23436, '2013-05-12', 'exce', 'good', 'fair', 'poor', 'none'),
(9, 54321, '2014-12-04', 'good', 'fair', 'exce', 'poor', 'none');
-- 
-- Database: `computer_parts_store`
-- 
CREATE DATABASE `computer_parts_store` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
-- 
-- Table structure for table `audiodevice_specs`
-- 

CREATE TABLE `audiodevice_specs` (
...
-- 
-- Dumping data for table `audiodevice_specs`
-- 

INSERT INTO `audiodevice_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `power`, `channels`, `quantity`, `price`, `rating`) VALUES 
(1, '917140603030', 'NS-PCS20', 'Insignia - 2.0 Stereo Computer Speaker System', 'Insignia', NULL, '2.0', 12, 19.99, 0),
(2, '532502391839', '980-000417', 'Logitech - Z130 2.0 Speaker System', 'Logitech', '2.5W', '2.0', 4, 24.99, 0),
(3, '753928367991', 'COMPANION 2 SERIES III SYSTEM', 'Bose - Companion 2 Series III Multimedia Speaker System', 'Bose', NULL, '2.0', 22, 99.99, 0),
(4, '113103999526', 'KLIPSCH PRO', 'Klipsch - ProMedia 2.1 Speaker System', 'Klipsch', '200W', '2.1', 2, 139.99, 0),
(5, '450937980945', '980-000430', 'Logitech - Z506 5.1 Surround Sound Speakers', 'Logitech', '101W', '5.1', 9, 69.99, 0),
(6, '249562549847', 'NS-PCS21', 'Insignia - 2.1 Speaker System', 'Insignia', '12.8W', '2.1', 1, 29.99, 0),
(7, '296506407774', 'JEMBEBLKAM', 'JBL - Jembe 2.0 Entertainment Speaker System', 'JBL', '12W', '2.0', 33, 59.99, 0),
(8, '841751495214', 'COMPANION 20', 'Bose - Companion 20 Multimedia Speaker System', 'Bose', NULL, '2.0', 11, 249.99, 0),
(9, '348883243705', '980-000354', 'Logitech - Z323 Speaker System', 'Logitech', NULL, '2.1', 7, 69.99, 0),
(10, '013649112585', 'XD3', 'Cerwin Vega - 2.0 Powered Desktop Speaker', 'Cerwin Vega', '30W', '2.0', 10, 119.99, 0);
...
INSERT INTO `case_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `case_type`, `drive_bays`, `cooling_fans`, `height`, `width`, `depth`, `weight`, `quantity`, `price`, `rating`) VALUES 
(1, '314093624276', 'SOURCE 210ELITE BLACK', 'NZXT - Source 210 Elite ATX/Micro', 'NZXT', 'Mid-tower', '3 External; 8 Internal', 'One 120mm; One 140mm', '17.3 inches', '7.6 inches', '19.5 inches', '14.3 lbs', 7, 49.99, 0),
(2, '932759372220', 'GUARDIAN 921RB-BL', 'NZXT - Crafted Series Guardian 921 RB', 'NZXT', 'Mid-tower', '5 External; 4 Internal', '3', '18 inches', '8.1 inches', '20.5 inches', '18 lbs', 11, 69.99, 0),
(3, '741512798231', 'RX-I', 'Thermaltake - Overseer System Cabinet', 'Thernaltake', 'Full-tower', '9', '3', '21.0 inches', '8.7 inches', '22.8 inches', '22.71 lbs', 3, 129.99, 0),
(4, '960960693109', 'CA-PH530-W1', 'NZXT - Phantom 530', 'NZXT', 'Full-tower', '3 External; 6 Internal', 'One 200mm; one 140mm', '22.5 inches', '9.25 inches', '21.4 inches', '23.1 lbs', 8, 115.98, 0),
(5, '339878834845', 'RC-912-KKN1', 'Cooler Master - HAF91', 'Cooler Master', 'Mid-tower', '4 External; 6 Internal', '2', '18.9 inches', '9.1 inches', '19.5 inches', '16.5 lbs', 22, 59.99, 0),
(6, '692394982632', 'CC-9011011-WW', 'Corsair - Carbide Series 400R', 'Corsair', 'Mid-tower', '4 External; 6 Internal', '3', '19.8 inches', '8.1 inches', '20.5 inches', '15.6 lbs', 1, 99.99, 0),
(7, '699718448510', 'PHANTOM BLACK', 'NZXT - Phantom', 'NZXT', 'Full-tower', NULL, 'Three 120mm; One 200mm', '21.2 inches', '8.7 inches', '24.5 inches', '24.2 lbs', 9, 119.99, 0),
(8, '817942524754', 'PHANTOM 410 RED', 'NZXT - Phantom 410', 'NZXT', 'Mid-tower', '3 External; 6 Internal', 'One 120mm; One 140mm', '20.3 inches', '8.4 inches', '20.9 inches', '19.8 inches', 5, 99.99, 0),
(9, '895258665153', 'PHANTOM 820 GUNMETAL', 'NZXT - Phantom 820', 'NZXT', 'Full-tower', '4 External; 6 Internal', NULL, '25.5 inches', '9.2 inches', '24 inches', '32 lbs', 10, 219.99, 0),
(10, '742260511866', 'NSK4482B', 'Antec - Computer Case', 'Antec', 'Mid-tower', '5 External; 3 Internal', '1', '16.6 inches', '7.8 inches', '16.5 inches', '18 lbs', 15, 119.99, 0);
...
-- 
-- Table structure for table `diskdrive_specs`
-- 

CREATE TABLE `diskdrive_specs` (
  `id` int(11) NOT NULL auto_increment,
  `upc` char(12) NOT NULL,
  `model_number` varchar(30) default NULL,
  `product_name` varchar(100) default NULL,
...
-- 
-- Dumping data for table `diskdrive_specs`
-- 

INSERT INTO `diskdrive_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `media_supported`, `read_speed`, `write_speed`, `height`, `width`, `depth`, `weight`, `quantity`, `price`, `rating`) VALUES 
(1, '981184522557', 'GH24NS90', 'LG - Super-Multi 24x Internal Drive', 'LG', 'DVD; CD', '16x DVD; 48x CD', '16x DVD; 48x CD', '1.6 inches', '5.7 inches', '6.5 inches', '1.8 lbs', 4, 39.99, 0),
(2, '746099014346', 'DRW-24B3ST', 'Asus - Internal DVD-Writer Drive', 'Asus', 'DVD; CD', '16x DVD; 48x CD', '24x DVD; 48x CD', '1.6 inches', '5.7 inches', '6.7 inches', '1.43 lbs', 8, 27.94, 0),
(3, '508462381942', 'SH-224DB', 'Samsung Internal DVD-Writer Drive', 'Samsung', 'DVD; CD', '16x DVD; 48x CD', '24x DVD; 48x CD', '1.6 inches', '5.7 inches', '6.6 inches', '1.5 lbs', 10, 15.99, 0),
(4, '748273673077', '343791-B21', 'HP - Internal CD/DVD Combo Drive', 'HP', 'DVD; CD', '24x CD', '8x DVD; 24x CD', '1.6 inches', '5.7 inches', '6.7 inches', '1.7 lbs', 14, 129.99, 0),
(5, '028565261535', 'BDR-2206', 'Pioneer - Write DVD Internal Blu-ray Writer Drive', 'Pioneer', 'DVD; CD', '16x DVD; 40x CD', '16x DVD; 40x CD', '1.7 inches', '5.8 inches', '7.1 inches', '1.8 lbs', 1, 147.99, 0),
(6, '941783065156', '447328-B21', 'HP - DVD Internal DVD-Writer Drive', 'HP', 'DVD; CD', '16x DVD; 40x CD', '16x DVD; 40x CD', '1.63 inches', '5.7 inches', '7.9 inches', '2.0 lbs', 13, 71.99, 0),
(7, '768934499035', '331346-B21', 'HP - Internal DVD-Reader Drive', 'HP', 'DVD; CD', '16x DVD; 48x CD', NULL, '1.7 inches', '5.9 inches', '8.2 inches', '1.9 lbs', 18, 129.99, 0),
(8, '322193164371', '447326-B21', 'HP - DVD-ROM Drive', 'HP', 'DVD; CD', '16x DVD; 40x CD', NULL, '1.6 inches', '5.7 inches', '7.9 inches', '1.6 lbs', 17, 129.99, 0),
(9, '331406930270', 'BDR-2208B5PK', 'Pioneer - Internal Blu-ray Disc', 'Pioneer', 'DVD; CD', '8x DVD; 40x CD', '8x DVD; 24x CD', '1.7 inches', '5.8 inches', '7.1 inches', '1.6 lbs', 9, 129.99, 0),
(10, '237196904346', '43N3292', 'Lenovo Slim CD/DVD Combo Drive', 'Lenovo', 'DVD; CD', '8x DVD; 24x CD', '24x CD', '0.4 inches', '5 inches', '5. inches', '4.94 oz', 3, 86.99, 0);

-- --------------------------------------------------------

-- 
-- Table structure for table `externalstorage_specs`
-- 

CREATE TABLE `externalstorage_specs` (
  `id` int(11) NOT NULL auto_increment,
  `upc` int(10) unsigned NOT NULL,
  `manufacturer` varchar(45) default NULL,
...
-- 
-- Dumping data for table `externalstorage_specs`
-- 
...
-- 
-- Table structure for table `harddrive_specs`
-- 

CREATE TABLE `harddrive_specs` (
  `id` int(11) NOT NULL auto_increment,
  `upc` char(12) NOT NULL,
  `model_number` varchar(30) default NULL,
  `product_name` varchar(100) default NULL,
...
-- 
-- Dumping data for table `harddrive_specs`
-- 

INSERT INTO `harddrive_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `capacity`, `connectivity`, `height`, `width`, `depth`, `weight`, `type`, `quantity`, `price`, `rating`) VALUES 
(1, '788197088710', 'STDR1000100', 'Seagate - Backup Plus Slim External Hard Drive', 'Seagate', '1TB', 'USB 2.0|USB 3.0', '4.5 inches', '3 inches', '0.5 inches', '5.6 ounces', 'external', 5, 89.99, 0),
(2, '938618267419', 'WDBZFP0010BBK-NESN', 'WD - My Passport Ultra External Hard Drive', 'WD', '1TB', 'USB 3.0', '4.4 inches', '3.2 inches', '0.6 inches', '5.4 ounces', 'external', 13, 89.99, 0),
(3, '289497211406', 'HDTC720XK3C1', 'Toshiba - Canvio Connect External Hard Drive', 'Toshiba', '2TB', 'USB 2.0|USB 3.0', '0.8 inches', '3.1 inches', '4.4 inches', '8.1 ounces', 'external', 8, 119.99, 0),
(4, '062623782530', 'HDTD205XK3D1', 'Toshiba - Canvio Slim II External Hard Drive', 'Toshiba', '500GB', 'USB 2.0|USB 3.0', '0.4 inches', '3 inches', '4.2 inches', '4.4 ounces', 'external', 18, 59.99, 0),
(5, '598462817090', 'WDBPGC5000ABK-NESN', 'WD - My Passport Ultra External Hard Drive', 'WD', '500GB', 'USB 3.0', '0.5 inches', '3.2 inches', '4.3 inches', '4.8 ounces', 'external', 22, 69.99, 0),
(6, '330359398803', 'STCD500102', 'Seagate - Slim External Hard Drive', 'Seagate', '500GB', 'USB 2.0|USB 3.0', '4.5 inches', '3 inches', '0.4 inches', '5.3 ounces', 'external', 1, 69.99, 0),
(7, '354801120607', 'STDR2000100', 'Seagate - Backup Plus External Hard Drive', 'Seagate', '2TB', 'USB 2.0|USB 3.0', '4.5 inches', '3 inches', '0.5 inches', '4.8 ounces', 'external', 11, 149.99, 0),
(8, '663444910925', 'WDBFJK0030HBK-NESN', 'WD - My Book External Hard Drive', 'WD', '3TB', 'USB 3.0', '6.7 inches', '1.9 inches', '5.5 inches', '2.2 lbs', 'external', 15, 139.99, 0),
(9, '982488131586', 'WDBFJK0040HBK-NESN', 'WD - My Book External Hard Drive', 'WD', '4TB', 'USB 3.0', '6.7 inches', '1.9 inches', '5.5 inches', '2.3 lbs', 'external', 4, 179.99, 0),
(10, '990174053204', 'HDWC130XK3J1', 'Toshiba - Canvio External Hard Drive', 'Toshiba', '3TB', 'USB 3.0', '6.6 inches', '1.7 inches', '5.1 inches', '2.2 lbs', 'external', 10, 119.99, 0),
(11, '953535355844', 'ST310005N1A1AS-RK', 'Seagate - Internal Serial ATA Hard Drive', 'Seagate', '1TB', 'Serial ATA', '5.75 inches', '4 inches', '0.5 inches', '14.4 ounces', 'internal', 4, 69.99, 0),
(12, '828057211933', 'WDBH2D0010HNC-NRSN', 'WD - Mainstream Internal Serial ATA Hard Drive', 'WD', '1TB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.5 lbs', 'internal', 10, 69.99, 0),
(13, '221074893050', 'ST3500641AS-RK', 'Seagate - Barracuda Internal Serial ATA Hard Drive', 'Seagate', '500GB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.6 lbs', 'internal', 13, 64.99, 0),
(14, '266043032497', 'WDBMYH3200ANC-NRSN', 'WD - Mainstream Internal Serial ATA Hard Drive', 'WD', '320GB', 'Serial ATA', '0.4 inches', '2.75 inches', '3.9 inches', '4.3 ounces', 'internal', 18, 49.99, 0),
(15, '555413386388', 'STBD2000101', 'Seagate - Barracuda Internal Serial ATA Hard Drive', 'Seagate', '2TB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.5 lbs', 'internal', 22, 104.99, 0),
(16, '692225505815', 'ST903203N1A', 'Seagate - Internal Serial ATA Hard Drive', 'Seagate', '320GB', 'Serial ATA', '0.4 inches', '2.75 inches', '3.9 inches', '4.3 ounces', 'internal', 1, 54.99, 0),
(17, '388411912493', 'WDBH2D0020HNC-NRSN', 'WD - Mainstream Internal Serial ATA Hard Drive', 'WD', '2TB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.5 lbs', 'internal', 29, 99.99, 0),
(18, '156396561740', 'STBD3000100', 'Seagate - Barracuda Internal Serial ATA Hard Drive', 'Seagate', '3TB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.4 lbs', 'internal', 3, 134.99, 0),
(19, '390056350246', 'WDBH2D5000ENC-NRSN', 'WD - Mainstream Internal Serial ATA Hard Drive', 'WD', '500GB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.5 lbs', 'internal', 8, 69.99, 0),
(20, '603084577589', 'WDBSLA0020HNC-NRSN', 'WD - Performance Internal Serial ATA Hard Drive', 'WD', '2TB', 'Serial ATA', '1 inches', '4 inches', '5.8 inches', '1.5 lbs', 'internal', 11, 164.99, 0),
(21, '569835797801', 'MZ-7TE250BW', 'Samsung - 840 EVO ', 'Samsung', '250GB', 'Serial ATA III', '0.3 inches', '2.75 inches', '3.9 inches', '14 ounces', 'ssd', 8, 189.99, 0),
(22, '419867533731', 'BBSSDSC240A4K5', 'Intel - 530 Series', 'Intel', '240GB', 'Serial ATA', '0.3 inches', '2.5 inches', '5.7 inches', '12 ounces', 'ssd', 6, 219.99, 0),
(23, '713184859718', 'HDTS312XZSTA', 'Toshiba - Q Series Pro', 'Toshiba', '128G', 'Serial ATA', '0.3 inches', '2.75 inches', '3.9 inches', '1.7 ounces', 'ssd', 15, 99.99, 0),
(24, '502628309078', 'HDTS325XZSTA', 'Toshiba - Q Series Pro', 'Toshiba', '256GB', 'Serial ATA', '0.3 inches', '2.75 inches', '3.9 inches', '1.9 ounces', 'ssd', 11, 189.99, 0),
(25, '358375978463', 'SSD9SC120GMDF-RB', 'PNY - XLR8', 'PNY', '120GB', 'Serial ATA III', '0.4 inches', '2.8 inches', '3.9 inches', '2.8 ounces', 'ssd', 23, 69.99, 0),
(26, '102005599491', 'BBSSDSC180A4K5', 'Intel - 530 Series', 'Intel', '180GB', 'Serial ATA', '0.3 inches', '2.5 inches', '5.7 inches', '12 ounces', 'ssd', 17, 169.99, 0),
(27, '389087246481', 'MZ-7PD256BW', 'Samsung - 840 Pro', 'Samsung', '256GB', 'Serial ATA', '0.3 inches', '2.5 inches', '5.7 inches', '3.2 ounces', 'ssd', 8, 209.95, 0),
(28, '909962479554', 'M500', 'Crucial - 2.5" Internal Solid State Drive', 'Crucial', '240GB', 'Serial ATA', '0.3 inches', '2.5 inches', '5.7 inches', '3.0 ounces', 'ssd', 7, 129.99, 0),
(29, '433387437950', 'MZ-7TE500LW', 'Samsung - 840 EVO', 'Samsung', '500GB', 'Serial ATA III', '0.3 inches', '2.75 inches', '3.9 inches', '3.2 ounces', 'ssd', 20, 499.99, 0),
(30, '547112596560', 'SH103S3B/240G', 'Kingston Technology - HyperX 3K', 'Kingston', '240GB', 'Serial ATA III', '0.4 inches', '2.8 inches', '3.9 inches', '2.8 ounces', 'ssd', 11, 239.99, 0);
...
INSERT INTO `keyboard_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `palm_rest`, `quantity`, `price`, `rating`) VALUES 
(1, '403863974309', 'MK320', 'Logitech - Wireless Desktop Keyboard and Mouse', 'Logitech', 'N', 4, 39.99, 0),
(2, '255898603849', '920-003070', 'Logitech - K400 Wireless Keyboard', 'Logitech', 'N', 11, 39.99, 0),
(3, '583726911227', 'MC184LL/B', 'Apple - Wireless Keyboard', 'Apple', 'N', 22, 69.99, 0),
(4, '641018216973', 'DX-WRK1401', 'Dynex - USB Keyboard', 'Dynex', 'N', 1, 9.99, 0),
(5, '846103447891', 'K3500', 'HP - Wireless Keyboard', 'HP', 'N', 13, 29.99, 0),
(6, '483891903042', 'DX-WLC1401', 'Dynex - Wireless Keyboard and Wireless Mouse', 'Dynes', 'N', 10, 29.99, 0),
(7, '110366410820', '920-004088', 'Logitech - K360 Wireless Keyboard', 'Logitech', 'N', 8, 29.99, 0),
(8, '121522927341', 'L3V-00001', 'Microsoft - Sculpt Comfort Wireless Keyboard and Mouse', 'Microsoft', 'Y', 17, 79.99, 0),
(9, '582624314100', 'B2M-00012', 'Microsoft - Natural Ergonomic Keyboard', 'Microsoft', 'Y', 3, 49.99, 0),
(10, '758601404569', 'K4000', 'HP - Bluetooth Wireless Keyboard', 'HP', 'N', 7, 49.99, 0);
...
(1, '051280138282', 'MD2048SD2-800', 'PNY - Optima', 'PNY', '2GB', 'PC2-6400 DDR2', '240-pin DIMM', 6, 39.99, 0),
(2, '375810824808', 'MN4096SD3-1333', 'PNY - SDRAM', 'PNY', '4GB', 'PC3-10666 DDR3', '204-pin SoDIMM', 11, 44.99, 0),
(3, '559502911619', 'MN8192KD31333AP', 'PNY - Optima', 'PNY', '8GB', 'PC3-10666 DDR3', '240-pin DIMM', 2, 74.99, 0),
(4, '522214049122', 'CMSO8GX3M2A1333C9', 'Corsair - 2 Pack', 'Corsair', '8GB', 'DDR3', '204-pin SoDIMM', 20, 79.99, 0),
(5, '327332181118', 'CMSX16GX3M2A1600C10', 'Corsair - Vengeance', 'Corsair', '16GB', 'DDR3', '204-pin SoDIMM', 10, 169.99, 0),
(6, '242066224606', 'KHX1600C9D3B1/4G', 'Kingston - HyperX blu', 'Kingston', '4GB', 'DDR3', '240-pin DIMM', 1, 44.99, 0),
(7, '412560231474', 'MD4096KD2-800', 'PNY - Optima 2-Pack', 'PNY', '4GB', 'PC2-6400 DDR2', '240-pin DIMM', 13, 59.99, 0),
(8, '452374510501', 'CT25664BA1339', 'Crucial - Memory Module', 'Crucial', '2GB', 'PC3-10600 DDR3', '240-pin SDRAM DIMM', 8, 22.94, 0),
(9, '898429769115', 'KVR13N9S8/4', 'Kingston Technology - Non-ECC Memory', 'Kingston', '4GB', 'PC3-10600 DDR3', '240-pin DIMM', 7, 36.95, 0),
(10, '089297398488', 'CM10246412800SOX20240', 'CMS - Apple Mac Memory', 'CMS', '16GB', 'PC3-12800 DDR3', '240-pin DIMM', 14, 175, 0);
...
INSERT INTO `monitor_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `type`, `screen_size`, `resolution`, `input_types`, `height`, `width`, `weight`, `quantity`, `price`, `rating`) VALUES 
(1, '630415913783', 'S200HQL BD', 'Acer - 20" LED HD Monitor', 'Acer', 'LED', '20"', '1600x900', 'VGA', '13.1 inches', '18.3 inches', '5.1 lbs', 8, 129.99, 0),
(2, '728352743019', 'S22C300HS', 'Samsung - 21.5" LED HD Monitor', 'Samsung', 'LED', '21.5"', '1920x1080', 'VGA; HDMI', '15.7 inches', '20.1 inches', '6.4 lbs', 18, 169.99, 0),
(3, '093789111058', 'S2440L', 'Dell - 24" LED HD Monitor', 'Dell', 'LED', '24"', '1920x1080', 'VGA; HDMI', '16.5 inches', '22.3 inches', '10.9 lbs', 4, 249.99, 0),
(4, '958824534729', 'I2269VW', 'AOC - 21.5" IPS LED HD Monitor', 'AOC', 'LED', '21.5"', '1920x1080', 'VGA; DVI', '15.6 inches', '19.6 inches', '7.7 lbs', 20, 149.99, 0),
(5, '885687124065', '22bw', 'HP - Pavilion 21.5" IPS LED HD Monitor', 'HP', 'LED', '21.5"', '1920x1080', 'VGA; DVI; HDMI', '15 inches', '21 inches', '10 lbs', 17, 179.99, 0),
(6, '951134090923', 'H236HL BID', 'Acer - H6 Series 23" IPS LED HD Monitor', 'Acer', 'LED', '23"', '1920x1080', 'VGA; DVI; HDMI', '15.9 inches', '20.9 inches', '7.9 lbs', 1, 179.99, 0),
(7, '942191869826', 'S27C390H', 'Samsung - 27" LED HD Monitor', 'Samsung', 'LED', '27"', '1920x1080', 'VGA; HDMI', '18.5 inches', '25.3 inches', '9.2 lbs', 9, 279.99, 0),
(8, '667753879007', 'VN247HP', 'Asus - 23.6" LED HD Monitor', 'Asus', 'LED', '23.6"', '1920x1080', 'VGA; DVI; HDMI', '15.5 inches', '21.6 inches', '8.2 lbs', 21, 189.99, 0),
(9, '795492234843', 'T232HL ABMJJZ', 'Acer - 23" IPS LED HD Touch-Screen Monitor', 'Acer', 'LED', '23"', '1920x1080', 'VGA; HDMI', '17.9 inches', '21.5 inches', '12.6 lbs', 11, 449.99, 0),
(10, '868294066763', 'E2060SWD', 'AOC - 19.5" LED HD Monitor', 'AOC', 'LED', '19.5"', '1600x900', 'VGA; DVI', '14.1 inches', '18.8 inches', '6.1 lbs', 2, 109.99, 0);
...
INSERT INTO `motherboard_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `multiple_gpu_supported`, `memory_slots`, `maximum_memory`, `pci_slots`, `usb_ports`, `ps2_ports`, `width`, `depth`, `quantity`, `price`, `rating`) VALUES 
(1, '984825424845', 'GA-Z87X-UD3H', 'GIGABYTE - ATX Motherboard', 'GIGABYTE', 'N', 4, '32GB', '4', '6', 'Yes', '12 inches', '9 inches', 5, 169.99, 0),
(2, '144065846337', 'Z87-PLUS', 'Asus - Desktop Motherboard', 'Asus', 'CrossFireX, SLI', 4, '32GB', '5', '6', 'Yes', '12 inches', '9.2 inches', 13, 160.85, 0),
(3, '272482002423', 'Z87-G45 GAMING', 'MSI - Desktop Motherboard', 'MSI', 'CrossFireX, SLI', 4, '64GB', '7', '6', 'Yes', '12 inches', '9.6 inches', 15, 158.85, 0),
(4, '395392964480', 'MAXIMUS VI HERO', 'Asus - Desktop Motherboard', 'Asus', 'CrossFireX, SLI', 4, '32GB', '6', '8', 'Yes', '12 inches', '9.6 inches', 3, 200, 0),
(5, '080774826382', 'SABERTOOTH990FXR2.0', 'Asus - Sabertooth', 'Asus', 'N', 4, '32GB', '4', '10', 'Yes', '12 inches', '9.2 inches', 18, 190.99, 0),
(6, '899654232663', 'GA-F2A88X-UP', 'Gigabyte - Ultra Durable 5 Plus', 'Gigabyte', 'Hybrid CrossFireX', 4, '64GB', '1', '6', 'Yes', '12 inches', '9.6 inches', 1, 110.99, 0),
(7, '547205891226', 'P8Z77-V', 'Asus - ATX Motherboard', 'Asus', 'CrossFireX, SLI', 4, '32GB', '2', '6', '1', '12 inches', '9.9 inches', 17, 165.99, 0),
(8, '182703908300', 'P8B75-M/CSM', 'Asus - Micro ATX Motherboard', 'Asus', 'CrossFireX, SLI', 4, '32GB', '1', '6', 'Yes', '12 inches', '9.6 inches', 4, 79.99, 0),
(9, '397227395576', 'G1.Sniper M5', 'Gigabyte - Ultra Durable 5 Plus', 'Gigabyte', 'CrossFireX, SLI', 4, '32GB', '4', '6', 'Yes', '9.6 inches', '9.6 inches', 11, 200.5, 0),
(10, '703147012578', '990FXA-GD80V2', 'MSI - Desktop Motherboard', 'MSI', 'CrossFireX, SLI', 4, '32GB', '1', '6', 'Yes', '12 inches', '9.6 inches', 8, 171.99, 0);
...
-- 
-- Table structure for table `printer_specs`
-- 
...
-- 
-- Dumping data for table `printer_specs`
-- 

INSERT INTO `printer_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `cartridges`, `wireless`, `height`, `width`, `depth`, `weight`, `quantity`, `price`, `rating`) VALUES 
(1, '238978325024', 'XP-410 - C11CC87201', 'Epson - Expression Home XP-410', 'Epson', '1 Black, 1 Cyan, 1 Magenta, 1 Yellow', 'Yes', '11 inches', '15.4 inches', '20.8 inches', '9 lbs', 8, 99.99, 0),
(2, '037242441440', 'A9T80A', 'HP - Envy 4500', 'HP', '1 Black, 1 Tricolor', 'Yes', '4.7 inches', '17.5 inches', '13.2 inches', '12.3 lbs', 13, 99.99, 0),
(3, '208609417443', '6520', 'HP - Photosmart 6520', 'HP', '1 Black, 1 Cyan, 1 Magenta, 1 Yellow', 'Yes', '17.2 inches', '17.3 inches', '22.2 inches', '13.7 lbs', 1, 149.99, 0),
(4, '951631378633', '7520', 'HP - Photosmart 7520', 'HP', '1 Black, 1 Cyan, 1 Magenta, 1 Yellow', 'Yes', '8.7 inches', '17.9 inches', '21.7 inches', '23.4 lbs', 18, 199.99, 0),
(5, '208503198140', 'OJPro 8600', 'HP - Officejet Pro 8600', 'HP', '1 Black, 1 Cyan, 1 Magenta, 1 Yellow', 'Yes', '11.8 inches', '19.4 inches', '16.3 inches', '26.4 lbs', 4, 199.99, 0),
(6, '442196628299', 'OFFICEJET 4630', 'HP - Officejet', 'HP', '1 Black, 1 Tricolor', 'Yes', '7.4 inches', '17.6 inches', '13.1 inches', '16.7 lbs', 9, 99.99, 0),
(7, '116342689751', 'ENVY 5530', 'HP - Envy 5530', 'HP', '1 Black, 1 Tricolor', 'Yes', '4.7 inches', '17.5 inches', '13.2 inches', '12.3 lbs', 14, 129.99, 0),
(8, '577533118081', 'CZ155A#B1H', 'HP - Officejet 660', 'HP', '1 Black, 1 Cyan, 1 Magenta, 1 Yellow', 'Yes', '9.9 inches', '18.3 inches', '21.9 inches', '17.2 lbs', 3, 149.99, 0),
(9, '676353817297', 'DESKJET 2540', 'HP - Deskjet', 'HP', '1 Black, 1 Tricolor', 'Yes', '9.9 inches', '16.7 inches', '21.7 inches', '7.9 lbs', 12, 79.99, 0),
(10, '285998533868', 'MX452', 'Canon - PIXMA MX 452', 'Canon', '3 Black, 2 Color', 'Yes', '7.9 inches', '18.1 inches', '15.2 inches', '19 lbs', 4, 99.99, 0);

-- --------------------------------------------------------

-- 
-- Table structure for table `processor_specs`
-- 
...
-- 
-- Dumping data for table `processor_specs`
-- 

INSERT INTO `processor_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `number_of_cores`, `clock_speed`, `quantity`, `price`, `rating`) VALUES 
(1, '031790888857', 'BX80646I74770K', 'Intel - Core i7-4770K', 'Intel', 4, '3.5GHz', 5, 349.99, 0),
(2, '080895089725', 'BX80646I54670K', 'Intel - Core i5-4670K', 'Intel', 4, '3.4GHz', 2, 249.99, 0),
(3, '325810731231', 'FX-8350', 'AMD - Socket AM3', 'AMD', 8, '4GHz', 13, 200, 0),
(4, '519029564436', 'A10-5800K', 'AMD - Socket FM2', 'AMD', 4, '3.8GHz', 9, 131.99, 0),
(5, '641831305975', 'BX80646I54570', 'Intel - Core i5-4570', 'Intel', 4, '3.2GHz', 14, 196.99, 0),
(6, '251094082084', 'X5650', 'HP - Intel Xeon', 'HP', 6, '2.66GHz', 7, 585.99, 0),
(7, '429147053335', '40K2519', 'IBM - Intel Xeon ', 'IBM', 1, '3.8GHz', 11, 389.4, 0),
(8, '746166240653', '8216', 'HP - AMD Opteron', 'HP', 2, '2.4GHz', 1, 129.95, 0),
(9, '821993860636', 'E7340', 'HP - Intel Xeon MP', 'HP', 4, '2.4GHz', 14, 768, 0),
(10, '918037000157', 'L5240', 'HP - Intel Xeon DP', 'HP', 2, '3GHz', 3, 129.99, 0);
...
-- 
-- Table structure for table `videocard_specs`
-- 

CREATE TABLE `videocard_specs` (
  `id` int(11) NOT NULL auto_increment,
  `upc` char(12) NOT NULL,
  `model_number` varchar(30) default NULL,
  `product_name` varchar(100) default NULL,
...
-- 
-- Dumping data for table `videocard_specs`
-- 

INSERT INTO `videocard_specs` (`id`, `upc`, `model_number`, `product_name`, `manufacturer`, `slot_type`, `output_types`, `quantity`, `price`, `rating`) VALUES 
(1, '033121700247', 'VCGGT6302XPB', 'PNY - GeForce GT 630', 'PNY', 'PCI Express', 'HDMI; DVI; VGA', 12, 99.99, 0),
(2, '240478439816', 'R5230ACLHR', 'XFX - Core Edition Radeon', 'XFX', 'PCI Express', 'HDMI; DVI; VGA', 4, 49.99, 0),
(3, '966084824029', 'VCGGTX650XPB', 'PNY - XLR8 GeForce GTX 650', 'PNY', 'PCI Express', 'HDMI; DVI', 6, 159.99, 0),
(4, '310064315011', '900120052500000', 'NVIDIA - GeForce GTX 770', 'NVIDIA', 'PCI', 'HDMI; DVI', 11, 379.99, 0),
(5, '669459135508', '02G-P4-3769-KB', 'EVGA - NVIDIA GeForce GTX 760', 'NVIDIA', 'PCI Express', 'HDMI; DVI', 14, 299.99, 0),
(6, '086429566733', 'R9-270X-CDFR', 'XFX - Radeon R9 270X', 'XFX', 'PCI Express 3.0', 'HDMI; DVI', 1, 249.99, 0),
(7, '010079795943', '900120042510000', 'NVIDIA - GeForce GTX 760', 'NVIDIA', 'PCI Express', 'HDMI; DVI', 7, 299.99, 0),
(8, '156102241006', 'BB61TGS4HX2LTX', 'Galaxy - GeForce GT 610 GC', 'NVIDIA', 'PCI Express', 'HDMI; DVI; VGA', 19, 49.99, 0),
(9, '355697406613', '64TGF8HX6FTZ', 'Galaxy - GeForce GT 640', 'NVIDIA', 'PCI Express 3.0', 'HDMI; DVI; VGA', 3, 99.99, 0),
(10, '888300786827', '02G-P4-3059-KB', 'EVGA - GeForce GTX 650 Ti', 'NVIDIA', 'PCI Express', 'HDMI; DVI', 10, 210.99, 0);
...
-- Database: `exams`
-- 
CREATE DATABASE `exams` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `exams`;

-- --------------------------------------------------------

-- 
-- Table structure for table `mysqlexam`
-- 

CREATE TABLE `mysqlexam` (
...
-- 
-- Dumping data for table `mysqlexam`
-- 

INSERT INTO `mysqlexam` (`QuestionID`, `Question`, `AnswerA`, `AnswerB`, `AnswerC`, `AnswerD`, `Correct`) VALUES 
(1, 'Which statement is used to insert new data in a database?', 'INSERT NEW', 'INSERT INTO', 'ADD NEW', 'ADD ROW', 'B'),
(2, 'How do you select all the columns from a table named "Persons"?', 'SELECT * FROM Persons', 'SELECT Persons', 'SELECT [all] FROM Persons', 'SELECT *.Persons', 'A'),
(3, 'What does SQL stand for?', 'Structured Query Language', 'Structured Question Language', 'Strong Question Language', 'None of the above', 'A'),
(4, 'Which of the following is not a valid aggregate function?', 'COUNT', 'MIN', 'MAX', 'COMPUTE', 'D'),
(5, 'Which clause is used to restrict the rows returned by a query?', 'AND', 'WHERE', 'HAVING', 'FROM', 'B');

-- --------------------------------------------------------

-- 
-- Table structure for table `phpexam`
-- 

CREATE TABLE `phpexam` (
  `QuestionID` smallint(6) NOT NULL auto_increment,
  `Question` text NOT NULL,
  `AnswerA` text NOT NULL,
  `AnswerB` text NOT NULL,
...
-- 
-- Dumping data for table `phpexam`
-- 

INSERT INTO `phpexam` (`QuestionID`, `Question`, `AnswerA`, `AnswerB`, `AnswerC`, `AnswerD`, `Correct`) VALUES 
(1, 'What does PHP stand for?', 'Private Home Page', 'PHP: Hypertext Preprocessor', 'Personal Home Page', 'Personal Hypertext Processor', 'B'),
(2, 'How do you get information from a form that is submitted using the "get" method?', 'Request.QueryString;', 'Request.Form;', '$_GET[];', '$_POST[];', 'C'),
(3, 'What is the correct way to add 1 to the $count variable?', '$count =+1', 'count++;', '$count++;', '++count', 'C'),
(4, 'Which one of these variables has an illegal name?', '$myVar', '$my_Var', '$my-Var', '$myVar1', 'C'),
(5, 'All variables in PHP start with which symbol?', '!', '$', '%', '&', 'B');
-- 
...
(NULL, 'airline', 'surveyinfo', 'surveyindex', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'FlightNum', 2, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'FlightDate', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'Friendliness', 4, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'Space', 5, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'Comfort', 6, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'Cleanliness', 7, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'airline', 'surveyinfo', 'Noise', 8, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'answers', 'question_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'answers', 'answer_numner', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'answers', 'answer', 3, NULL, 'YES', 'varchar', 500, 1500, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'power', 6, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'channels', 7, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'quantity', 8, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'price', 9, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'rating', 10, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'case_type', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'drive_bays', 7, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'cooling_fans', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'height', 9, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'width', 10, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'depth', 11, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'weight', 12, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'quantity', 13, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'price', 14, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'case_specs', 'rating', 15, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'order_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'upc', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'email', 3, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'quantity', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'subtotal', 5, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'tax', 6, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'shipping', 7, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'current_orders', 'total', 8, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'media_supported', 6, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'read_speed', 7, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'write_speed', 8, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'height', 9, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'width', 10, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'depth', 11, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'weight', 12, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'quantity', 13, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'price', 14, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'rating', 15, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'upc', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'manufacturer', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'capacity', 4, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'connectivity', 5, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'height', 6, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'width', 7, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'depth', 8, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'weight', 9, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'quantity', 10, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'price', 11, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'capacity', 6, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'connectivity', 7, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'height', 8, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'width', 9, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'depth', 10, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'weight', 11, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'type', 12, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'quantity', 13, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'price', 14, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 'rating', 15, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'palm_rest', 6, NULL, 'YES', 'varchar', 1, 3, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'quantity', 7, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'price', 8, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 'rating', 9, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'capacity', 6, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'type', 7, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'pin_configuration', 8, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'quantity', 9, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'price', 10, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'memory_specs', 'rating', 11, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'type', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'screen_size', 7, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'resolution', 8, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'input_types', 9, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'height', 10, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'width', 11, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'weight', 12, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'quantity', 13, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'price', 14, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 'rating', 15, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES 
(NULL, 'computer_parts_store', 'motherboard_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'multiple_gpu_supported', 6, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'memory_slots', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'maximum_memory', 8, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'pci_slots', 9, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'usb_ports', 10, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'ps2_ports', 11, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'width', 12, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'depth', 13, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'quantity', 14, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'price', 15, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 'rating', 16, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'payment_information', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'payment_information', 'email', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'payment_information', 'card_type', 3, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'payment_information', 'card_number', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(16)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'payment_information', 'name_on_card', 5, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'payment_information', 'security_code', 6, NULL, 'YES', 'char', 3, 9, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'cartridges', 6, NULL, 'YES', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'wireless', 7, NULL, 'YES', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'height', 8, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'width', 9, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'depth', 10, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'weight', 11, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'quantity', 12, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'price', 13, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'printer_specs', 'rating', 14, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'number_of_cores', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'clock_speed', 7, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'quantity', 8, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'price', 9, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'processor_specs', 'rating', 10, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'product_reviews', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'questions', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'questions', 'question', 2, NULL, 'YES', 'varchar', 500, 1500, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'questions_answers', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 'email', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 'upc', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 'quantity', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'email', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'password', 3, NULL, 'NO', 'char', 102, 306, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(102)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'firstName', 4, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'middleInitial', 5, NULL, 'YES', 'char', 1, 3, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'lastName', 6, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'homePhone', 7, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'cellPhone', 8, NULL, 'YES', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'active', 9, NULL, 'YES', 'char', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(32)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'billStreetAddress', 10, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'billCity', 11, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'billState', 12, NULL, 'NO', 'char', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(2)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'billZipcode', 13, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'shipStreetAddress', 14, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'shipCity', 15, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'shipState', 16, NULL, 'NO', 'char', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(2)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'user', 'shipZipcode', 17, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'upc', 2, NULL, 'NO', 'char', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'char(12)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'model_number', 3, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'product_name', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'manufacturer', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'slot_type', 6, NULL, 'YES', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'output_types', 7, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'quantity', 8, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'price', 9, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 'rating', 10, '0', 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'QuestionID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'Question', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'AnswerA', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'AnswerB', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'AnswerC', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'AnswerD', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'mysqlexam', 'Correct', 7, NULL, 'NO', 'enum', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''A'',''B'',''C'',''D'')', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'QuestionID', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'Question', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'AnswerA', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'AnswerB', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'AnswerC', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'AnswerD', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'exams', 'phpexam', 'Correct', 7, NULL, 'NO', 'enum', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''A'',''B'',''C'',''D'')', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'computer', 'Compid', 1, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'computer', 'Mfgname', 2, NULL, 'NO', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'computer', 'Mfgmodel', 3, NULL, 'NO', 'char', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'computer', 'Proctype', 4, NULL, 'NO', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'employee', 'Empnum', 1, '0', 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'employee', 'Emname', 2, NULL, 'YES', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'employee', 'Empphone', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'package', 'Packid', 1, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'package', 'Packname', 2, NULL, 'NO', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'package', 'Packver', 3, NULL, 'NO', 'decimal', NULL, NULL, 4, 2, NULL, NULL, 'decimal(4,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'package', 'Packtype', 4, NULL, 'NO', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'package', 'Packcost', 5, NULL, 'NO', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'pc', 'Tagnum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'pc', 'Compid', 2, NULL, 'YES', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'pc', 'Empnum', 3, NULL, 'YES', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'pc', 'Location', 4, NULL, 'YES', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'software', 'Packid', 1, '', 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'software', 'Tagnum', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'software', 'Instdata', 3, NULL, 'YES', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab1', 'software', 'Softcost', 4, NULL, 'YES', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'computer', 'Compid', 1, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'computer', 'Mfgname', 2, NULL, 'NO', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'computer', 'Mfgmodel', 3, NULL, 'NO', 'char', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'computer', 'Proctype', 4, NULL, 'NO', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'employee', 'Empnum', 1, '0', 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'employee', 'Empname', 2, NULL, 'YES', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'employee', 'Empphone', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'package', 'Packid', 1, NULL, 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'package', 'Packname', 2, NULL, 'NO', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'package', 'Packver', 3, NULL, 'NO', 'decimal', NULL, NULL, 4, 2, NULL, NULL, 'decimal(4,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'package', 'Packtype', 4, NULL, 'NO', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'package', 'Packcost', 5, NULL, 'NO', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'pc', 'Tagnum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'pc', 'Compid', 2, NULL, 'YES', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'pc', 'Empnum', 3, NULL, 'YES', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'pc', 'Location', 4, NULL, 'YES', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'software', 'Packid', 1, '', 'NO', 'char', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(4)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'software', 'Tagnum', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'software', 'Instdate', 3, NULL, 'YES', 'char', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'lab2', 'software', 'Softcost', 4, NULL, 'YES', 'decimal', NULL, NULL, 6, 2, NULL, NULL, 'decimal(6,2)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'phpmyadmin', 'pma_bookmark', 'query', 5, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_bin', 'text', '', '', 'select,insert,update,references', ''),
...
(NULL, 'phpmyadmin', 'pma_history', 'sqlquery', 6, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_bin', 'text', '', '', 'select,insert,update,references', ''),
...
(NULL, 'test', 'te', '1', 1, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'test', 'te', '2', 2, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'test', 'te', '3', 3, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'test', 'te', '4', 4, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'test', 'te', '5', 5, '', 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', '');
...
(NULL, 'airline', 'PRIMARY', NULL, 'airline', 'surveyinfo', 'surveyindex', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'answers', 'question_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'answers', 'answer_numner', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'audiodevice_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'audiodevice_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'audiodevice_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'audiodevice_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'case_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'case_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'case_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'case_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'current_orders', 'order_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'current_orders', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'current_orders', 'email', 3, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'diskdrive_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'diskdrive_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'diskdrive_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'diskdrive_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'externalstorage_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'externalstorage_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'externalstorage_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'externalstorage_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'harddrive_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'harddrive_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'harddrive_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'harddrive_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'keyboard_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'keyboard_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'keyboard_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'keyboard_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'memory_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'memory_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'memory_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'memory_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'monitor_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'monitor_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'monitor_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'monitor_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'motherboard_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'motherboard_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'motherboard_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'motherboard_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'payment_information', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'payment_information', 'email', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'payment_information', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'email', NULL, 'computer_parts_store', 'payment_information', 'email', 1, 1, 'computer_parts_store', 'user', 'email'),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'printer_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'printer_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'printer_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'printer_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'processor_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'processor_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'processor_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'processor_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'product_reviews', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'product_reviews', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'questions', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'questions', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'questions_answers', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'questions_answers', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'shopping_cart', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'shopping_cart', 'email', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'shopping_cart', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'user', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'user', 'email', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'user', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'email_UNIQUE', NULL, 'computer_parts_store', 'user', 'email', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'videocard_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'PRIMARY', NULL, 'computer_parts_store', 'videocard_specs', 'upc', 2, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'id_UNIQUE', NULL, 'computer_parts_store', 'videocard_specs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'computer_parts_store', 'upc_UNIQUE', NULL, 'computer_parts_store', 'videocard_specs', 'upc', 1, NULL, NULL, NULL, NULL),
(NULL, 'exams', 'PRIMARY', NULL, 'exams', 'mysqlexam', 'QuestionID', 1, NULL, NULL, NULL, NULL),
(NULL, 'exams', 'PRIMARY', NULL, 'exams', 'phpexam', 'QuestionID', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'PRIMARY', NULL, 'lab1', 'computer', 'Compid', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'PRIMARY', NULL, 'lab1', 'employee', 'Empnum', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'PRIMARY', NULL, 'lab1', 'package', 'Packid', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'PRIMARY', NULL, 'lab1', 'pc', 'Tagnum', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'PRIMARY', NULL, 'lab1', 'software', 'Packid', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'PRIMARY', NULL, 'lab1', 'software', 'Tagnum', 2, NULL, NULL, NULL, NULL),
(NULL, 'lab1', 'software_ibfk_1', NULL, 'lab1', 'software', 'Packid', 1, 1, 'lab1', 'package', 'Packid'),
(NULL, 'lab1', 'software_ibfk_2', NULL, 'lab1', 'software', 'Tagnum', 1, 1, 'lab1', 'pc', 'Tagnum'),
(NULL, 'lab2', 'PRIMARY', NULL, 'lab2', 'computer', 'Compid', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab2', 'PRIMARY', NULL, 'lab2', 'employee', 'Empnum', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab2', 'PRIMARY', NULL, 'lab2', 'package', 'Packid', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab2', 'PRIMARY', NULL, 'lab2', 'pc', 'Tagnum', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab2', 'PRIMARY', NULL, 'lab2', 'software', 'Packid', 1, NULL, NULL, NULL, NULL),
(NULL, 'lab2', 'PRIMARY', NULL, 'lab2', 'software', 'Tagnum', 2, NULL, NULL, NULL, NULL),
(NULL, 'lab2', 'software_ibfk_1', NULL, 'lab2', 'software', 'Packid', 1, 1, 'lab2', 'package', 'Packid'),
(NULL, 'lab2', 'software_ibfk_2', NULL, 'lab2', 'software', 'Tagnum', 1, 1, 'lab2', 'pc', 'Tagnum'),
...
(NULL, 'airline', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'computer_parts_store', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'exams', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'lab1', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'lab2', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'phpmyadmin', 'utf8', 'utf8_bin', NULL),
...
(NULL, 'airline', 'surveyinfo', 0, 'airline', 'PRIMARY', 1, 'surveyindex', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'answers', 0, 'computer_parts_store', 'PRIMARY', 1, 'question_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'answers', 0, 'computer_parts_store', 'PRIMARY', 2, 'answer_numner', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'audiodevice_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'case_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'case_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'case_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'case_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'current_orders', 0, 'computer_parts_store', 'PRIMARY', 1, 'order_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'current_orders', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'current_orders', 0, 'computer_parts_store', 'PRIMARY', 3, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'current_orders', 1, 'computer_parts_store', 'email_idx', 1, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'diskdrive_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'externalstorage_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 30, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 30, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 30, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'harddrive_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 30, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'keyboard_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'memory_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'memory_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'memory_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'memory_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'monitor_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'motherboard_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'payment_information', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'payment_information', 0, 'computer_parts_store', 'PRIMARY', 2, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'payment_information', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'payment_information', 1, 'computer_parts_store', 'email_idx', 1, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'printer_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'printer_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'printer_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'printer_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'processor_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'processor_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'processor_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'processor_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'product_reviews', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'product_reviews', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'questions', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'questions', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'questions_answers', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'questions_answers', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 0, 'computer_parts_store', 'PRIMARY', 2, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'shopping_cart', 1, 'computer_parts_store', 'email_idx', 1, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'user', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'user', 0, 'computer_parts_store', 'PRIMARY', 2, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'user', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'user', 0, 'computer_parts_store', 'email_UNIQUE', 1, 'email', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 0, 'computer_parts_store', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 0, 'computer_parts_store', 'PRIMARY', 2, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 0, 'computer_parts_store', 'id_UNIQUE', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'computer_parts_store', 'videocard_specs', 0, 'computer_parts_store', 'upc_UNIQUE', 1, 'upc', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'exams', 'mysqlexam', 0, 'exams', 'PRIMARY', 1, 'QuestionID', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'exams', 'phpexam', 0, 'exams', 'PRIMARY', 1, 'QuestionID', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'computer', 0, 'lab1', 'PRIMARY', 1, 'Compid', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'employee', 0, 'lab1', 'PRIMARY', 1, 'Empnum', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'package', 0, 'lab1', 'PRIMARY', 1, 'Packid', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'pc', 0, 'lab1', 'PRIMARY', 1, 'Tagnum', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'software', 0, 'lab1', 'PRIMARY', 1, 'Packid', 'A', 9, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'software', 0, 'lab1', 'PRIMARY', 2, 'Tagnum', 'A', 9, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab1', 'software', 1, 'lab1', 'Tagnum', 1, 'Tagnum', 'A', 9, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'computer', 0, 'lab2', 'PRIMARY', 1, 'Compid', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'employee', 0, 'lab2', 'PRIMARY', 1, 'Empnum', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'package', 0, 'lab2', 'PRIMARY', 1, 'Packid', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'pc', 0, 'lab2', 'PRIMARY', 1, 'Tagnum', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'software', 0, 'lab2', 'PRIMARY', 1, 'Packid', 'A', 7, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'software', 0, 'lab2', 'PRIMARY', 2, 'Tagnum', 'A', 7, NULL, NULL, '', 'BTREE', ''),
(NULL, 'lab2', 'software', 1, 'lab2', 'Tagnum', 1, 'Tagnum', 'A', 7, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'test', 'te', 1, 'test', '1', 1, '1', NULL, NULL, NULL, NULL, '', 'FULLTEXT', ''),
(NULL, 'test', 'te', 1, 'test', '1', 2, '2', NULL, NULL, NULL, NULL, '', 'FULLTEXT', ''),
(NULL, 'test', 'te', 1, 'test', '1', 3, '3', NULL, NULL, NULL, NULL, '', 'FULLTEXT', ''),
(NULL, 'test', 'te', 1, 'test', '1', 4, '4', NULL, NULL, NULL, NULL, '', 'FULLTEXT', ''),
(NULL, 'test', 'te', 1, 'test', '1', 5, '5', NULL, NULL, NULL, NULL, '', 'FULLTEXT', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-04-14 00:46:29', '2014-04-14 00:46:29', NULL, 'utf8_general_ci', NULL, 'max_rows=3381', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-04-14 00:46:29', '2014-04-14 00:46:29', NULL, 'utf8_general_ci', NULL, 'max_rows=3726', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-04-14 00:46:29', '2014-04-14 00:46:29', NULL, 'utf8_general_ci', NULL, 'max_rows=3108', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-04-14 00:46:29', '2014-04-14 00:46:29', NULL, 'utf8_general_ci', NULL, 'max_rows=6123', ''),
(NULL, 'airline', 'surveyinfo', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 0, 10, '2014-03-19 22:34:43', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'answers', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 0, NULL, '2014-04-13 16:40:30', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'audiodevice_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'case_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'current_orders', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 0, NULL, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'diskdrive_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'externalstorage_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 0, 1, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'harddrive_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 30, 546, 16384, 0, 32768, 0, 36, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'keyboard_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'memory_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'monitor_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'motherboard_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 28, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'payment_information', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 0, 1, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB; (`email`) REFER `computer_parts_store/user`(`email`) ON D'),
(NULL, 'computer_parts_store', 'printer_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'processor_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'product_reviews', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 0, 1, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'questions', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 0, 1, '2014-04-13 16:40:30', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'questions_answers', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 0, 1, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'shopping_cart', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 0, 1, '2014-04-13 16:40:30', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 0, 8, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'computer_parts_store', 'videocard_specs', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 32768, 0, 11, '2014-04-10 16:46:51', NULL, NULL, 'utf8_general_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'exams', 'mysqlexam', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 0, 6, '2014-04-08 15:16:54', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'exams', 'phpexam', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 0, 6, '2014-04-07 21:25:19', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab1', 'computer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 0, NULL, '2014-02-24 20:36:42', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab1', 'employee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 0, NULL, '2014-02-24 20:37:10', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab1', 'package', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 0, NULL, '2014-02-24 21:59:17', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab1', 'pc', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 0, NULL, '2014-02-24 20:39:06', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab1', 'software', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 16384, 0, NULL, '2014-02-24 22:09:47', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB; (`Packid`) REFER `lab1/package`(`Packid`); (`Tagnum`) REF'),
(NULL, 'lab2', 'computer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 0, NULL, '2014-03-12 17:43:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab2', 'employee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 0, NULL, '2014-03-12 17:43:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab2', 'package', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 0, NULL, '2014-03-12 17:43:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab2', 'pc', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 0, NULL, '2014-03-12 17:43:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB'),
(NULL, 'lab2', 'software', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 0, NULL, '2014-03-12 17:43:07', NULL, NULL, 'latin1_swedish_ci', NULL, '', 'InnoDB free: 11264 kB; (`Packid`) REFER `lab2/package`(`Packid`); (`Tagnum`) REF'),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 876, 123286039799267327, 4096, 876, NULL, '2006-03-31 13:29:25', '2006-06-09 12:43:52', NULL, 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 36, 581, 20916, 163536961468891135, 3072, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 378, 197, 74466, 55450570411999231, 15360, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 726, 9, 6534, 2533274790395903, 12288, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 458, 538, 246744, 281474976710655, 16384, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 109775240917155839, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 48, 48, 281474976710655, 2048, 0, NULL, '2006-03-31 13:29:25', '2006-03-31 19:29:26', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, 1, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
(NULL, 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, 1, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, 1, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, 1, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, NULL, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'Relation table'),
(NULL, 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, NULL, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
(NULL, 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 9, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, NULL, '2004-10-26 17:06:36', '2004-10-26 23:06:36', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin'),
(NULL, 'test', 'te', 'BASE TABLE', 'MyISAM', 7, 'Dynamic', 0, 0, 0, 4294967295, 1024, 0, NULL, '2003-12-18 06:42:26', '2003-12-18 13:42:26', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'airline', 'PRIMARY', 'airline', 'surveyinfo', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'answers', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'audiodevice_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'audiodevice_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'audiodevice_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'case_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'case_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'case_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'current_orders', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'diskdrive_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'diskdrive_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'diskdrive_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'externalstorage_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'externalstorage_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'externalstorage_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'harddrive_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'harddrive_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'harddrive_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'keyboard_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'keyboard_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'keyboard_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'memory_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'memory_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'memory_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'monitor_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'monitor_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'monitor_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'motherboard_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'motherboard_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'motherboard_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'payment_information', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'payment_information', 'UNIQUE'),
(NULL, 'computer_parts_store', 'email', 'computer_parts_store', 'payment_information', 'FOREIGN KEY'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'printer_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'printer_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'printer_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'processor_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'processor_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'processor_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'product_reviews', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'product_reviews', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'questions', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'questions', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'questions_answers', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'questions_answers', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'shopping_cart', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'shopping_cart', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'user', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'user', 'UNIQUE'),
(NULL, 'computer_parts_store', 'email_UNIQUE', 'computer_parts_store', 'user', 'UNIQUE'),
(NULL, 'computer_parts_store', 'PRIMARY', 'computer_parts_store', 'videocard_specs', 'PRIMARY KEY'),
(NULL, 'computer_parts_store', 'id_UNIQUE', 'computer_parts_store', 'videocard_specs', 'UNIQUE'),
(NULL, 'computer_parts_store', 'upc_UNIQUE', 'computer_parts_store', 'videocard_specs', 'UNIQUE'),
(NULL, 'exams', 'PRIMARY', 'exams', 'mysqlexam', 'PRIMARY KEY'),
(NULL, 'exams', 'PRIMARY', 'exams', 'phpexam', 'PRIMARY KEY'),
(NULL, 'lab1', 'PRIMARY', 'lab1', 'computer', 'PRIMARY KEY'),
(NULL, 'lab1', 'PRIMARY', 'lab1', 'employee', 'PRIMARY KEY'),
(NULL, 'lab1', 'PRIMARY', 'lab1', 'package', 'PRIMARY KEY'),
(NULL, 'lab1', 'PRIMARY', 'lab1', 'pc', 'PRIMARY KEY'),
(NULL, 'lab1', 'PRIMARY', 'lab1', 'software', 'PRIMARY KEY'),
(NULL, 'lab1', 'software_ibfk_1', 'lab1', 'software', 'FOREIGN KEY'),
(NULL, 'lab1', 'software_ibfk_2', 'lab1', 'software', 'FOREIGN KEY'),
(NULL, 'lab2', 'PRIMARY', 'lab2', 'computer', 'PRIMARY KEY'),
(NULL, 'lab2', 'PRIMARY', 'lab2', 'employee', 'PRIMARY KEY'),
(NULL, 'lab2', 'PRIMARY', 'lab2', 'package', 'PRIMARY KEY'),
(NULL, 'lab2', 'PRIMARY', 'lab2', 'pc', 'PRIMARY KEY'),
(NULL, 'lab2', 'PRIMARY', 'lab2', 'software', 'PRIMARY KEY'),
(NULL, 'lab2', 'software_ibfk_1', 'lab2', 'software', 'FOREIGN KEY'),
(NULL, 'lab2', 'software_ibfk_2', 'lab2', 'software', 'FOREIGN KEY'),
...
-- Database: `lab1`
-- 
CREATE DATABASE `lab1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `lab1`;
...
CREATE TABLE `computer` (
  ...
  `Mfgname` char(10) NOT NULL,
  `Mfgmodel` char(5) NOT NULL,
  `Proctype` char(10) NOT NULL,
  PRIMARY KEY  (`Compid`)
...
INSERT INTO `computer` (`Compid`, `Mfgname`, `Mfgmodel`, `Proctype`) VALUES 
('B121', 'Bantam', '48X', 'PENI'),
('B221', 'Bantam', '48D', 'PENIII'),
('C007', 'Cody', 'D1', 'PENII'),
('M759', 'Lemmin', 'GRL', 'PENIV');
...
CREATE TABLE `employee` (
  `Empnum` smallint(6) NOT NULL default '0',
  `Emname` char(20) default NULL,
...
INSERT INTO `employee` (`Empnum`, `Emname`, `Empphone`) VALUES 
...
CREATE TABLE `package` (
  ...
  `Packname` char(20) NOT NULL,
  `Packver` decimal(4,2) NOT NULL,
  `Packtype` char(20) NOT NULL,
  `Packcost` decimal(6,2) NOT NULL,
  PRIMARY KEY  (`Packid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `package` (`Packid`, `Packname`, `Packver`, `Packtype`, `Packcost`) VALUES 
('AC01', 'Boise Accounting', 3.00, 'Accounting', 725.83),
('DB32', 'Manta', 1.50, 'Database', 380.00),
('DB33', 'Manta', 2.10, 'Database', 430.18),
('SS11', 'Limitless View', 5.30, 'Spreadsheet', 217.94),
('WP08', 'Words ans More', 2.00, 'Word Processing', 185.00),
...
CREATE TABLE `pc` (
  ...
  `Compid` char(4) default NULL,
  `Empnum` smallint(6) default NULL,
...
INSERT INTO `pc` (`Tagnum`, `Compid`, `Empnum`, `Location`) VALUES 
...
CREATE TABLE `software` (
  `Packid` char(4) NOT NULL default '',
  `Tagnum` int(11) NOT NULL default '0',
  `Instdata` char(10) default NULL,
  `Softcost` decimal(6,2) default NULL,
...
INSERT INTO `software` (`Packid`, `Tagnum`, `Instdata`, `Softcost`) VALUES 
...
ALTER TABLE `software`
  ADD CONSTRAINT `software_ibfk_1` FOREIGN KEY (`Packid`) REFERENCES `package` (`Packid`),
  ADD CONSTRAINT `software_ibfk_2` FOREIGN KEY (`Tagnum`) REFERENCES `pc` (`Tagnum`);
-- 
-- Database: `lab2`
-- 
CREATE DATABASE `lab2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `lab2`;
...
INSERT INTO `employee` (`Empnum`, `Empname`, `Empphone`) VALUES 
(124, 'Alvarez, Ramon', 1212),
(567, 'Feinstein, Betty', 8716),
(611, 'Dinh, Melissa', 2963);
...
INSERT INTO `package` (`Packid`, `Packname`, `Packver`, `Packtype`, `Packcost`) VALUES 
('AC01', 'Boise Accounting', 3.00, 'Accounting', 735.83),
('DB32', 'Manta', 1.50, 'Database', 390.00),
('DB33', 'Manta', 2.10, 'Database', 440.18),
('SS11', 'Limitless View', 5.30, 'Spreadsheet', 227.94),
('WP08', 'Words and More', 2.00, 'Word Processing', 195.00),
('WP09', 'Freeware Processing', 4.27, 'Word Processing', 40.00);
...
INSERT INTO `software` (`Packid`, `Tagnum`, `Instdate`, `Softcost`) VALUES 
('AC01', 32808, '09/13/95', 754.95),
('DB33', 57772, '05/27/95', 412.77),
('WP08', 32808, '01/12/96', 185.00),
('WP08', 37691, '06/15/95', 227.50),
